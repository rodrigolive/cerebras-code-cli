...
002-ready-p1-fix-memory-leak.md
005-complete-p2-refactor-api-client.md
```
...
2. Copy template: `cp .opencode/skill/file-todos/assets/todo-template.md todos/{NEXT_ID}-pending-{priority}-{description}.md`
...
- Different from the file-based system
